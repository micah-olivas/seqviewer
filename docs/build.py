...
.run { margin: 1.1rem 0 1.2rem; }
.run pre {
  font: 0.78rem/1.55 ui-monospace, SFMono-Regular, "SF Mono", Menlo, Consolas,
        monospace;
  margin: 0; padding: 0.7rem 0.9rem; white-space: pre; overflow-x: auto;
}
